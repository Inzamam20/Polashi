...
- [ ] Deployed to Vercel + Render (pending user action)
...
The phase now follows the **canonical Avalon moderator script** with thumb mechanic (10 steps, 0–9):
0. Role distribution (15s) — private RoleCard reveal, like dealing cards
...
*Mission 4 with 7+ players needs **2 Fail cards** to be sabotaged.*
